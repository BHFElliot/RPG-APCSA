...
public class Intro{
  ...
  public static void backStory() {
    ...
    Printers.printlnSleep(3500, "A breeze of cold air brings you to. You open your eyes only to find yourself completely enshrouded in darkness.");
  ...
  //just picks if the player goes down the civilization path or the organism path, commented for now to allow development on the civ path.
